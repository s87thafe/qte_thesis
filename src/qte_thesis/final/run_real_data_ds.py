...
def run_ds(tau: float, csv_source: Path, produces: Path, seed: int | None = None, n_subsample: int | None = None, subsample_id: int | None = None) -> None:
...
if __name__ == "__main__":
    args = parse_args()
    out = BLD_data / f"real_data_{args.tau}_ds_sub{args.subsample_id}.csv"
    run_ds(
        tau=args.tau,
